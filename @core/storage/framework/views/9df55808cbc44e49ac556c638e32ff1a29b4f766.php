...
<?php $__env->startSection('style'); ?>
    ...
    .single-orders {
        background: rgb(40 35 94);
        padding: 15px 20px;
        box-shadow: 0 0 40px 0 rgba(40,35,94,.3);
    }

    .orders-child:nth-child(4n+2) .single-orders {
        background: rgb(29 191 115);
        box-shadow: 0 0 40px 0 rgba(29,191,115,.5);
    }

    .orders-child:nth-child(4n+3) .single-orders {
        box-shadow: 0 0 40px 0 rgba(86,184,211,.5);
        background: rgb(86 184 211);
    }

    .orders-child:nth-child(4n+4) .single-orders {
        background: rgb(101 96 255);
        box-shadow: 0 0 40px 0 rgba(101,96,255,.5);
    }

    .orders-child:nth-child(4n+3) .single-orders .icon
    {
        color: rgb(86 184 211);
    }
            ...
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            <h2 class="order-titles"><?php echo e(float_amount_with_currency_symbol($total_tax)); ?> </h2>
                            <span class="order-para"><?php echo e(__('Total Tax')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            ...
                            <span class="order-para"><?php echo e(__('Total Order')); ?> </span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            <h2 class="order-titles"> <?php echo e($cancel_order); ?> </h2>
                            <span class="order-para"><?php echo e(__('Order Cancel')); ?> </span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            <h2 class="order-titles"> <?php echo e($total_service); ?> </h2>
                            <span class="order-para"><?php echo e(__('Total Service')); ?> </span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/backend/admin-home.blade.php ENDPATH**/ ?>