                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.license.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="envato_username" value="<?php echo e(get_static_option("license_username")); ?>" placeholder="xxxxx">
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/backend/general-settings/license-settings.blade.php ENDPATH**/ ?>