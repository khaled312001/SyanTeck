...
<div class="new_banner_area new-section-bg padding-top-100 padding-bottom-100 hero-section-enhanced" data-padding-top="<?php echo e($padding_top); ?>" data-padding-bottom="<?php echo e($padding_bottom); ?>"
     style="background-color: <?php echo e($header_background_color); ?>; position: relative; overflow: hidden; padding-top: 120px !important; padding-bottom: 80px !important;">
    <!-- Background Pattern -->
                ...
                <div class="new_banner__contents">
                    ...
                    <div class="btn-wrapper btn_flex mt-4" style="display: flex; gap: 1rem; flex-wrap: wrap;">
                        <?php if(!empty($button_one_show_hide)): ?>
                            <a href="<?php echo e(url('/qr')); ?>" class="cmn-btn btn-outline-2 radius-5" style="padding: 1rem 2.5rem; border: 2px solid #667eea; color: #667eea; font-weight: 600; border-radius: 12px; transition: all 0.3s; display: inline-flex; align-items: center; gap: 0.5rem;">
