            ...
            <div class="col-xl-6 col-lg-7">
                <div class="new_banner__contents">
                    <div class="btn-wrapper mb-4" style="display: flex; justify-content: center; width: 100%;">
                        <a href="<?php echo e(url('/qr')); ?>" class="cmn-btn btn-bg-2 radius-5" style="padding: 1rem 2.5rem; background: #FFD700; color: #000; font-weight: 600; border-radius: 12px; transition: all 0.3s; display: inline-flex; align-items: center; gap: 0.5rem; box-shadow: 0 4px 15px rgba(255, 215, 0, 0.4);">
                            <i class="fa-solid fa-wrench"></i><?php echo e(__('أطلب صيانة الآن')); ?>
                    ...
                    <h2 class="new_banner__contents__title" style="font-size: 2.8rem; line-height: 1.3; font-weight: 800; margin-bottom: 0.8rem; color: #000; text-align: center;">
                        <?php if(!empty($highlighted_word)): ?>
                            <?php echo $title_start; ?> <?php echo $highlighted_word; ?> <span style="color: #000;"><?php echo e($title_end); ?></span>
                        <?php else: ?>
                            <?php echo $title_start; ?> <span class="color-three" style="color: #FFD700;"> <?php echo e($title_end); ?> </span>
                        <?php endif; ?>
                    </h2>
                    ...
                    <div class="new_banner__thumb" style="position: relative; z-index: 1;">
                        <div class="hero-video-wrapper" style="border-radius: 20px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.2); position: relative; width: 100%; max-width: 100%;">
                            <video autoplay muted loop playsinline style="width: 100%; height: auto; min-height: 400px; object-fit: cover; display: block; border-radius: 20px;" preload="auto">
                                <source src="<?php echo e(asset('assets/frontend/img/SyanaTech_Maintenance_Video_Creation.mp4')); ?>" type="video/mp4">
