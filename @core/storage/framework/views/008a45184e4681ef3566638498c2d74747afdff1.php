            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="new_service__single service-card-modern" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                    <div class="service-card-image-wrapper">
                        <a href="<?php echo e(route('service.list.details',$service->slug)); ?>" class="service-image-link">
                            <div class="service-image-container">
                                <img src="<?php echo e($image_url); ?>" alt="<?php echo e($service->title); ?>" class="service-image" loading="lazy">
                    ...
                    <div class="service-card-content">
                        ...
                        <div class="service-card-footer">
                            <a href="<?php echo e(route('service.list.book',$service->slug)); ?>" class="service-book-btn-modern"
                               style="background:<?php echo e($btn_color); ?>; color:<?php echo e($button_text_color); ?>">
