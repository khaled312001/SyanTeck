...
<?php endif; ?>
    <style>
        ...
        .page-builder-area-wrapper .available-form-field li {
            z-index: unset;
        }
                ...
                * ---------------------------------*/
                ...
                $(document).on('click', '.widget-area-expand', function (e) {
                    ...
                    if (expand.hasClass('ti-angle-down')) {
                        ...
                        // if (expand.hasClass('ti-angle-down')) {
                        //     expand.attr('class', 'ti-angle-up');
                        //     widgetbody.removeClass('hide');
                        // } else {
                        //     expand.attr('class', 'ti-angle-down');
                        //     widgetbody.addClass('hide');
                        //
                        //     // Additional logic to hide content if needed
                        //     var allWidgets = $(this).parent().parent().find('.widget-area-body ul li');
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/backend/page-builder/dynamicpage.blade.php ENDPATH**/ ?>