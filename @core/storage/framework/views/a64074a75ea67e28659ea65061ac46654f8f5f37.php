   ...
   <?php if(!empty(get_static_option('site_google_analytics'))): ?>
    ...
    <?php echo render_favicon_by_id(get_static_option('site_favicon')); ?>
       ...
       <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/theme-two/css/animate.css')); ?>">
           ...
           <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/unified-spacing-system.css')); ?>">
...
<?php echo $__env->make('frontend.partials.navbar', ['page_post' => $page_post ?? null], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
