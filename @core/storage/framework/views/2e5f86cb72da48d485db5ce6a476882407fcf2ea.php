        ...
        //new add start
            ...
            if($('#order_from_user_wallet').val() == 'manual_payment'){
               ...
               // kinetic select bank name option show/hide
                <?php if(get_static_option('site_default_payment_gateway') === 'kineticpay'): ?>
...
</script><?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/components/payment-gateway-two-js.blade.php ENDPATH**/ ?>