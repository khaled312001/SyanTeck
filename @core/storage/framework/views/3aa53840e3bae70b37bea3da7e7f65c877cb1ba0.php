        ...
        <div class="container container-two">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 margin-bottom-30">
                    <div class="footer-widget widget">
                        <div class="about_us_widget">
                            <a href="<?php echo e(route('qr.index')); ?>" class="footer-logo" style="display: block; margin-bottom: 20px;">
                                <?php echo $siteLogo; ?>
                        ...
                        <div class="footer-inner">
                            ...
                            <div class="footer-socials">
                                <ul class="footer-social-list" style="display: flex; gap: 15px; list-style: none; padding: 0;">
                                    <?php if(!empty(get_static_option('site_facebook_link'))): ?>
                                    <li class="lists">
                                        <a href="<?php echo e(get_static_option('site_facebook_link')); ?>" target="_blank" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; background: #FFD700; border-radius: 50%; color: #000000; text-decoration: none; transition: all 0.3s;">
                                            <i class="lab la-facebook-f"></i>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                    <?php if(!empty(get_static_option('site_twitter_link'))): ?>
                                    <li class="lists">
                                        <a href="<?php echo e(get_static_option('site_twitter_link')); ?>" target="_blank" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; background: #FFD700; border-radius: 50%; color: #000000; text-decoration: none; transition: all 0.3s;">
                                            <i class="lab la-twitter"></i>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                    <?php if(!empty(get_static_option('site_instagram_link'))): ?>
                                    <li class="lists">
                                        <a href="<?php echo e(get_static_option('site_instagram_link')); ?>" target="_blank" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; background: #FFD700; border-radius: 50%; color: #000000; text-decoration: none; transition: all 0.3s;">
                                            <i class="lab la-instagram"></i>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                    <?php if(!empty(get_static_option('site_whatsapp_link'))): ?>
                                    <li class="lists">
                                        <a href="<?php echo e(get_static_option('site_whatsapp_link')); ?>" target="_blank" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; background: #FFD700; border-radius: 50%; color: #000000; text-decoration: none; transition: all 0.3s;">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 margin-bottom-30">
                    <div class="footer-widget widget">
                        <h6 class="widget-title" style="color: #FFD700; font-size: 18px; font-weight: 700; margin-bottom: 25px; text-transform: uppercase;"><?php echo e(__('Our Services')); ?></h6>
                        <div class="footer-inner">
                            <ul class="footer-link-list" style="list-style: none; padding: 0;">
                                <?php if($electricityCategory): ?>
                                <li class="list" style="margin-bottom: 12px;">
                                    <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 15px; display: flex; align-items: center; gap: 10px; transition: all 0.3s;">
                                        <i class="las la-bolt" style="color: #FFD700; font-size: 18px;"></i>
                                        <span><?php echo e($electricityCategory->name); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                <?php if($plumbingCategory): ?>
                                <li class="list" style="margin-bottom: 12px;">
                                    <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 15px; display: flex; align-items: center; gap: 10px; transition: all 0.3s;">
                                        <i class="las la-tools" style="color: #FFD700; font-size: 18px;"></i>
                                        <span><?php echo e($plumbingCategory->name); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                <?php if($acCategory): ?>
                                <li class="list" style="margin-bottom: 12px;">
                                    <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 15px; display: flex; align-items: center; gap: 10px; transition: all 0.3s;">
                                        ...
                                        <span><?php echo e($acCategory->name); ?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                            </ul>
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 margin-bottom-30">
                    <div class="footer-widget widget">
                        <h6 class="widget-title" style="color: #FFD700; font-size: 18px; font-weight: 700; margin-bottom: 25px; text-transform: uppercase;"><?php echo e(__('Quick Links')); ?></h6>
                        <div class="footer-inner">
                            <ul class="footer-link-list" style="list-style: none; padding: 0;">
                                <li class="list" style="margin-bottom: 12px;">
                                    <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 15px; transition: all 0.3s;"><?php echo e(__('Home')); ?></a>
                                </li>
                                <li class="list" style="margin-bottom: 12px;">
                                    <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 15px; transition: all 0.3s;"><?php echo e(__('About Us')); ?></a>
                                </li>
                                <li class="list" style="margin-bottom: 12px;">
                                    <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 15px; transition: all 0.3s;"><?php echo e(__('Services')); ?></a>
                                </li>
                                <li class="list" style="margin-bottom: 12px;">
                                    <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 15px; transition: all 0.3s;"><?php echo e(__('Contact Us')); ?></a>
                                </li>
                                <li class="list" style="margin-bottom: 12px;">
                                    <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 15px; transition: all 0.3s;"><?php echo e(__('Register')); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 margin-bottom-30">
                    <div class="footer-widget widget">
                        <h6 class="widget-title" style="color: #FFD700; font-size: 18px; font-weight: 700; margin-bottom: 25px; text-transform: uppercase;"><?php echo e(__('Contact Info')); ?></h6>
                        <div class="footer-inner">
                            <ul class="footer-link-address" style="list-style: none; padding: 0;">
                                <?php if(!empty(get_static_option('site_contact_address'))): ?>
                                <li class="list" style="margin-bottom: 15px; display: flex; align-items: flex-start; gap: 12px;">
                                    ...
                                    <span style="color: #CCCCCC; font-size: 14px; line-height: 1.6;"><?php echo e(get_static_option('site_contact_address')); ?></span>
                                </li>
                                <?php endif; ?>
                                <?php if(!empty(get_static_option('site_contact_phone'))): ?>
                                <li class="list" style="margin-bottom: 15px; display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <a href="tel:<?php echo e(get_static_option('site_contact_phone')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 14px;"><?php echo e(get_static_option('site_contact_phone')); ?></a>
                                </li>
                                <?php endif; ?>
                                <?php if(!empty(get_static_option('site_global_email'))): ?>
                                <li class="list" style="margin-bottom: 15px; display: flex; align-items: center; gap: 12px;">
                                    <i class="las la-envelope" style="color: #FFD700; font-size: 20px;"></i>
                                    <a href="mailto:<?php echo e(get_static_option('site_global_email')); ?>" style="color: #CCCCCC; text-decoration: none; font-size: 14px;"><?php echo e(get_static_option('site_global_email')); ?></a>
                                </li>
                                <?php endif; ?>
                            </ul>
                        </div>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="vision-2030-text" style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
                        ...
                        <div>
                            <h4 style="color: #FFFFFF; font-size: 20px; font-weight: 700; margin: 0 0 8px 0; text-shadow: 1px 1px 3px rgba(0,0,0,0.3);">
                                <?php echo e(__('دعم التحول الرقمي ضمن رؤية المملكة 2030')); ?>

                            </h4>
                            <p style="color: rgba(255, 255, 255, 0.9); font-size: 14px; margin: 0; line-height: 1.6;">
                                <?php echo e(__('نساهم في تحقيق أهداف رؤية المملكة 2030 من خلال تقديم حلول رقمية متطورة')); ?>
                ...
                <div class="col-lg-4 col-md-5 text-center text-md-left">
                    <div class="vision-2030-logo" style="position: relative;">
                        ...
                        <img src="<?php echo e(asset('assets/frontend/img/Saudi_Vision_2030_logo.svg.png')); ?>" 
                             ...
                             onerror="this.onerror=null; this.src='<?php echo e(asset('assets/frontend/img/Saudi_Vision_2030_logo.svg.png')); ?>';">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 text-right">
                    <div class="copyright-links" style="color: #CCCCCC; font-size: 14px;">
                        <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; margin-left: 20px; transition: all 0.3s;"><?php echo e(__('Privacy Policy')); ?></a>
                        <a href="<?php echo e(route('qr.index')); ?>" style="color: #CCCCCC; text-decoration: none; margin-left: 20px; transition: all 0.3s;"><?php echo e(__('Terms & Conditions')); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/frontend/partials/pages-portion/footers/footer-03.blade.php ENDPATH**/ ?>