                        ...
                        <li class="notification-btn-wrapper">
                            ...
                            <div class="notification-dropdown" id="notificationDropdown">
                                ...
                                <div class="nofity-list">
                                    <?php if(count($admin_unread_notifications) > 0): ?>
                                        <!-- Order section start -->
                                    ...
                                    <?php else: ?>
                                        <div class="notify-item" style="text-align: center; color: #6c757d;">
                                            <p><?php echo e(__('No New Notification')); ?></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right dropdown">
                        ...
                        <h4 class="user-name dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(Auth::user()->name); ?> <i class="fa fa-angle-down"></i></h4>
...
<?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/backend/admin-master.blade.php ENDPATH**/ ?>