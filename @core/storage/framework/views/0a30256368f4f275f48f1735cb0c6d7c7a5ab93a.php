        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li
                        ...
                        <ul class="collapse">
                            ...
                            <li class="<?php echo e(active_menu('admin-home/orders/cancel-orders')); ?>">
                                <a href="<?php echo e(route('admin.orders.cancel')); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('order-success-setting')): ?>
                                <li class="<?php echo e(active_menu('admin-home/orders/order-success-settings')); ?>">
                                    <a href="<?php echo e(route('admin.order.success.settings')); ?>"><?php echo e(__('Order Settings')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['service-list'])): ?>
                        <li
                            ...
                            <ul class="collapse">
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('service-list')): ?>
                                    <li class="<?php echo e(active_menu('admin-home/services/seller-service-coupons')); ?> <?php if(request()->is('admin-home/services/seller-service-coupons')): ?> active <?php endif; ?>">
                                        <a href="<?php echo e(route('admin.service.all.coupon.list')); ?>"><?php echo e(__('Seller Service Coupons')); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php endif; ?>
                               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('order-create-setting')): ?>
                                    <li class="<?php echo e(active_menu('admin-home/services/service-load-more-category-settings')); ?>"><a
                                      href="<?php echo e(route('admin.service.load.more.category.settings')); ?>"><?php echo e(__('Load More Settings')); ?></a></li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('order-create-setting')): ?>
                                   <li class="<?php echo e(active_menu('admin-home/services/service-zone-settings')); ?>">
                                       <a  href="<?php echo e(route('admin.service.zone.settings')); ?>"><?php echo e(__('Google Map Settings')); ?></a>
                                   </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['payout-list', 'admin-commission','amount-settings','all-seller'])): ?>
                        <li class="<?php echo e(active_menu('admin-home/area')); ?>
                            ...
                            <ul class="collapse">
                                ...
                                <?php endif; ?>
                               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['amount-settings'])): ?>
                                    <li class="<?php echo e(active_menu('admin-home/seller-settings/seller/profile/settings')); ?>">
                                        <a href="<?php echo e(route('admin.seller.profile.settings')); ?>" aria-expanded="true"><?php echo e(__('Seller Profile Settings')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['country-list', 'country-create'])): ?>
                       ...
                       <?php if(request()->is([
                            ...
                            <ul class="collapse">
                                ...
                                <?php endif; ?>
                               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country-list')): ?>
                                    <li class="<?php echo e(active_menu('admin-home/country/settings')); ?> <?php if(request()->is('admin-home/country/settings')): ?> active <?php endif; ?>"><a
                                         href="<?php echo e(route('admin.country.settings')); ?>"><?php echo e(__('Country Settings')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                            ...
                            <ul class="collapse">
                                <li class="<?php echo e(active_menu('admin-home/media-upload/page')); ?>">
                                    <a href="<?php echo e(route('admin.dashboard.variant')); ?>" aria-expanded="true">
                                        <?php echo e(__('Seller/Buyer Panel Settings')); ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['general-settings-reading-settings', 'general-settings-global-navbar-settings',
                        ...
                        <li class="<?php if(request()->is('admin-home/general-settings/*')): ?> active <?php endif; ?>">
                            ...
                            <ul class="collapse ">
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('general-settings-otp-settings')): ?>
                                    <li class="<?php echo e(active_menu('admin-home/general-settings/otp-settings')); ?>">
                                        <a href="<?php echo e(route('admin.general.otp.settings')); ?>"><?php echo e(__('OTP Settings')); ?></a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['notice-settings'])): ?>
                        <li class="main_dropdown
                        <?php if(request()->is(['admin-home/notice/*'])): ?> active <?php endif; ?> ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-bell"></i>
                                <span><?php echo e(__('Notice Settings')); ?></span></a>
                            <ul class="collapse">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('notice-settings')): ?>
                                    <li class="<?php echo e(active_menu('admin-home/notice/page')); ?>">
                                        <a href="<?php echo e(route('admin.all.notice')); ?>"><?php echo e(__('All Notice')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subscription-reminder')): ?>
                                            <li class="<?php echo e(active_menu('admin-home/subscription/settings')); ?> <?php if(request()->is('admin-home/subscription/settings/*')): ?> active <?php endif; ?>"><a
                                                href="<?php echo e(route('admin.subscription.settings')); ?>"><?php echo e(__('Subscription Settings')); ?></a></li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>