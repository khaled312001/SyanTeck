                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                <h3 class="dashboards-title"> <?php echo e(__('Report Details')); ?> </h3>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        <div class="header-wrap d-flex justify-content-between">
                                            <h4 class="header-title"><?php echo e(__('Report Details')); ?></h4>
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('admin.order.seller.buyer.report')); ?>"><?php echo e(__('All Reports')); ?></a>
                                        </div>

                                        <div class="gig-order-info">
                                            <p><strong><?php echo e(__('Report ID:')); ?></strong> #<?php echo e($report_details->id); ?></p>
                                            <p><strong><?php echo e(__('Order ID:')); ?></strong> #<?php echo e($report_details->order_id); ?></p>
                                            <p><strong><?php echo e(__('Report From:')); ?></strong> <?php echo e(__(ucfirst(strtolower($report_details->report_from)))); ?></p>
                                        </div>
                                        ...
                                        <div class="gig-message-start-wrap">
                                            ...
                                            <div class="all-message-wrap <?php if($q == 'all'): ?> msg-row-reverse <?php endif; ?>">
                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = $all_messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <div class="single-message-item <?php if($msg->type == 'seller'): ?> customer <?php endif; ?>">
                                                        <div class="top-part">
                                                            <div class="thumb">
                                                            <span class="title">
                                                                 <?php if($msg->type == 'seller'): ?>
                                                                    <?php echo e(substr(optional($report_details->seller)->name ?? 'S',0,1)); ?>

                                                                <?php else: ?>
                                                                    <span><?php echo e(__('A')); ?></span>
                                                                <?php endif; ?>
                                                            </span>
                                        ...
                                        <div class="reply-message-wrap ">
                                            <h4 class="title"><?php echo e(__('Reply To Message')); ?></h4>
...
<?php endif; ?>
                                            ...
                                            <form action="<?php echo e(route('admin.order.report.chat.seller',$report_details->id.'/'.$report_details->seller_id)); ?>" method="post" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="form-group">
                                                    <label for="" class="message_buyer_seller_text_title_color"><?php echo e(__('Message')); ?></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small class="info-text d-block text-danger"><?php echo e(__('max file size 200mb, only jpg, jpeg, png, pdf, csv and zip file is allowed')); ?></small>
                                                </div>
                                                <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/backend/pages/orders/report-chat.blade.php ENDPATH**/ ?>