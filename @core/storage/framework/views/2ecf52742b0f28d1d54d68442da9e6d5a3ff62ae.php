        ...
        <form method="get" action="<?php echo e($current_page_url); ?>" id="search_service_list_form">
            <div class="row">
                    ...
                    <div class="new_serviceDetails__side">
                        <div class="new_serviceDetails__side__item">
                            ...
                            <div class="service_filter_with_reset mb-3">
                                <h5 class="common-title"><?php echo e(__('Service Filter')); ?> </h5>
                               <a href="<?php echo e(url($url_search_services_list)); ?>">
                                <strong class="text-danger"><?php echo e(__('Reset Filter')); ?> </strong>
                               </a>
                            </div>

                            <!--Search any title filter start -->
                            <?php if(!empty($service_search_by_text_on_off)): ?>
                                    ...
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#textCollapse" data-bs-toggle="collapse" aria-expanded="true">
                                                <?php echo e(__('Search By text')); ?> <i class="las la-angle-down"></i> </a>
                                        </h6>
                            ...
                            <?php if(!empty($location_on_off)): ?>
                             <?php if(!empty(get_static_option("google_map_settings"))): ?>
                                <div class="new_serviceDetails__side__author">
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#distanceCollapse" data-bs-toggle="collapse" aria-expanded="true">  <?php echo e(__('Search By Location')); ?>
                                        ...
                                        <div class="collapse show" id="distanceCollapse">
                                            ...
                                            <div class="job_status_wise_section_start mt-2">
                                                <input type="hidden" name="remotely_button_filter" id="remotely_button_filter_value" value="<?php echo e($remote_task_title); ?>">
                                                <input type="hidden" name="all_button_filter_value" id="all_button_filter_value" value="<?php echo e($all_button_filter_value); ?>">
                                                <input type="hidden" name="in_person_filter_value" id="in_person_filter_value" value="<?php echo e($in_person_filter_value); ?>">
                                                <button type="button" class="all_location_new_btn <?php if(!empty($in_person_filter_value)): ?> btn btn-primary btn-sm <?php else: ?> btn btn-secondary btn-sm  <?php endif; ?> in_person_button_filter"><?php echo e(__('Offline')); ?> </button>
                                                <button type="button" class="all_location_new_btn <?php if(!empty($remote_task_title)): ?> btn btn-primary btn-sm <?php else: ?> btn btn-secondary btn-sm <?php endif; ?> remotely_button_filter" ><?php echo e(__('Online')); ?></button>
                                                <button type="button" class="all_location_new_btn <?php if(!empty($all_button_filter_value)): ?> btn btn-primary btn-sm <?php elseif(empty($remote_task_title) && empty($in_person_filter_value)): ?> btn btn-primary btn-sm <?php else: ?> btn btn-secondary btn-sm <?php endif; ?>
                                               all_button_filter"><?php echo e(__('All')); ?> </button>
                                            </div>
                                            ...
                                            <div class="slider-container slider-kilometer m-2">
                                                ...
                                                <strong class="mb-2"><?php echo e(__('Distance')); ?></strong>
                                                <div id="slider" class="slider-range mt-2"></div>
                                                <div id="slider-value" class="slider-range-value mt-2"></div>
                                                <span class="km_title_text" style="display: flex; margin-left: 23px; margin-top: -21px;"><?php echo e(__('km')); ?></span>
                                            </div>

                                            <!-- cancel and apply button start -->
                                            <div class="cancel_apply_section_start text-end mb-2">
                                                <button type="button" class="submit-btn btn-sm" id="distance_wise_filter_apply"><?php echo e(__('Filter')); ?></button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#distanceCollapseAnyPrice" data-bs-toggle="collapse" aria-expanded="false" class="toggle-collapse">
                                                <?php echo e(__('Search By Price')); ?> <i class="las la-angle-down"></i>
                                            </a>
                                        </h6>
                                        ...
                                        <div class="collapse show" id="distanceCollapseAnyPrice">
                                            ...
                                            <div class="cancel_apply_section_start text-end mt-3 mb-2">
                                                <button type="button" class="submit-btn btn-sm" id="price_wise_filter_apply"><?php echo e(__('Filter')); ?></button>
                                            </div>
                            ...
                            <?php if(empty(get_static_option("google_map_settings"))): ?>
                                ...
                                <div class="new_serviceDetails__side__author">
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#countryCollapse" data-bs-toggle="collapse" aria-expanded="true">  <?php echo e(__('Search By Country')); ?> <i class="las la-angle-down"></i> </a>
                                        </h6>
                            ...
                            <div class="new_serviceDetails__side__author">
                                <div class="new_serviceDetails__side__author__contents">
                                    <h6 class="new_packageBook__addFeature__title">
                                        <a href="#cityCollapse" data-bs-toggle="collapse" aria-expanded="true">  <?php echo e(__('Search By City')); ?> <i class="las la-angle-down"></i> </a>
                                    </h6>
                                        ...
                                        <div class="single-category-service">
                                            <div class="single-select">
                                                <select id="search_by_city" name="city">
                                                    ...
                                                    <?php $__currentLoopData = $services_city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service_city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> {
                                                      <option <?php if(!empty(request()->get("city")) && request()->get("city") == $service_city->id): ?> selected <?php endif; ?>
                                                      value="<?php echo e($service_city->id); ?>"><?php echo e($service_city->service_city); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <!--Area filter start -->
                            <?php if(empty(get_static_option("google_map_settings"))): ?>
                                <?php if(!empty($area_on_off)): ?>
                                    <div class="new_serviceDetails__side__author">
                                        <div class="new_serviceDetails__side__author__contents">
                                            <h6 class="new_packageBook__addFeature__title">
                                                <a href="#areaCollapse" data-bs-toggle="collapse" aria-expanded="true">  <?php echo e(__('Search By Area')); ?> <i class="las la-angle-down"></i> </a>
                                            </h6>
                                                ...
                                                <div class="single-category-service">
                                                    <div class="single-select">
                                                        <select id="search_by_area" name="area">
                                                            ...
                                                            <?php $__currentLoopData = $services_area; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service_area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> {
                                                              <option <?php if(!empty(request()->get("area")) && request()->get("area") == $service_area->id): ?> selected <?php endif; ?>
                                                              value="<?php echo e($service_area->id); ?>"><?php echo e($service_area->service_area); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(!empty($category_on_off)): ?>
                                <div class="new_serviceDetails__side__author">
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#categoryCollapse" data-bs-toggle="collapse" aria-expanded="true">  <?php echo e(__('Search By Category')); ?> <i class="las la-angle-down"></i> </a>
                                        </h6>
                            ...
                            <?php if(!empty($subcategory_on_off)): ?>
                                <div class="new_serviceDetails__side__author">
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#cubCategoryCollapse" data-bs-toggle="collapse" aria-expanded="true">  <?php echo e(__('Search By Sub-Category')); ?> <i class="las la-angle-down"></i> </a>
                                        </h6>
                            ...
                            <?php if(!empty($child_category_on_off)): ?>
                                <div class="new_serviceDetails__side__author">
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#childCategoryCollapse" data-bs-toggle="collapse" aria-expanded="true">  <?php echo e(__('Search By Child Category')); ?> <i class="las la-angle-down"></i> </a>
                                        </h6>
                            ...
                            <?php if(!empty($subcategory_on_off)): ?>
                                <div class="new_serviceDetails__side__author">
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#starRatingCollapse" data-bs-toggle="collapse" aria-expanded="true">  <?php echo e(__('Search By Rating')); ?> <i class="las la-angle-down"></i> </a>
                                        </h6>
                                            ...
                                            <div class="single-category-service">
                                                <div class="single-select">
                                                    <select id="search_by_rating" name="rating">
                                                        ...
                                                        <?php $__currentLoopData = $rating_stars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if(!empty(request()->get("rating")) && request()->get("rating") == $value): ?> selected <?php endif; ?> value="<?php echo e($value); ?>"><?php echo e($text); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <?php if(!empty($sort_by_on_off)): ?>
                                <div class="new_serviceDetails__side__author">
                                    <div class="new_serviceDetails__side__author__contents">
                                        <h6 class="new_packageBook__addFeature__title">
                                            <a href="#sortbyCollapse" data-bs-toggle="collapse" aria-expanded="false">  <?php echo e(__('Search By Sort-by')); ?> <i class="las la-angle-down"></i> </a>
                                        </h6>
                ...
                <?php if(!empty(get_static_option("google_map_settings"))): ?>
                    ...
                    <?php if($all_services->total() > 0): ?>
                        <?php $__currentLoopData = $all_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="<?php echo e($columns ?? 'col-lg-4'); ?> mt-3 service-card-animated">
                                        <div class="new_service__single <?php echo e($google_map_style_class); ?>">
                                            ...
                                            <div class="new_service__single__contents">
                                                ...
                                                <h5 class="new_service__single__contents__title">
                                                    <a href="<?php echo e(route('service.list.details',$service->slug)); ?>"><?php echo e($service->title); ?></a></h5>
                                                <div class="btn-wrapper border_top">
                                                    <a href="<?php echo e(route("service.list.book", $service->slug)); ?>" class="cmn-btn btn-outline-border w-100 radius-5"> <?php echo e($book_now_text); ?> </a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="justify-content-end mt-5">
                              <h5 class="common-title text-danger"><?php echo e(__('no service found')); ?></h5>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                ...
                <?php else: ?>
                    ...
                    <?php if($all_services->total() > 0): ?>
                        <?php $__currentLoopData = $all_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="<?php echo e($columns ?? 'col-lg-4'); ?> service-card-animated">
                                        <div class="new_service__single <?php echo e($google_map_style_class); ?>">
                                            <div class="new_service__single__thumb">
                                                <a href="<?php echo e(route("service.list.details", $service->slug)); ?>">
                                                    <?php echo render_image_markup_by_attachment_id($service->image, '','','thumb'); ?>
...
<?php if(!empty(get_static_option("google_map_settings"))): ?>
    ...
    <script>
        ...
        let book_now_title = <?php echo json_encode($book_now_text, 15, 512) ?>;
        function generateContent(place){
            var content = `<div class=\"single-service service-map-style no-margin wow\">
                      <a href=\"<?php echo e($service_details_route); ?>/`+place.slug+`\" class=\"service-thumb service-bg-thumb-format\" `+place.image_url+`>
                  </a>
                  <div class=\"services-contents\">
                      <h5 class=\"common-title map-view-service-title mt-2\"> <a href=\"<?php echo e($service_details_route); ?>/`+place.slug+`\" title=\"View: `+place.title+`\"> `+place.title+` </a> </h5>
                      <div class=\"btn-wrapper d-flex flex-wrap\">
                          <a href=\"<?php echo e($service_book_route); ?>/`+place.slug+`\" class=\"cmn-btn btn-small btn-bg-1\"> `+book_now_title+` </a>
                      </div>
                  </div>
              </div>`;
        ...
        var places = <?php echo json_encode($all_services_list_json, 15, 512) ?>;
        ...
        <?php if(!empty($latitude) && !empty($longitude)): ?>
            ...
            longitude = '<?php echo e($longitude); ?>'
        <?php else: ?>
        ...
        <?php if(empty($online_check_service)): ?>
            function addMarkers() {
                var min = 0.999999;
                var max = 1.000001;
                        ...
                        if (status === google.maps.GeocoderStatus.OK) {
                            if (results[0]) {
                                ...
                                if(formattedLocation){
                                    ...
                                    var in_person_filter_value_get = `<?php echo e($in_person_filter_value); ?>`;
...
<?php endif; ?>
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp\htdocs\SyanTeck\@core\app\Providers/../PageBuilder/views/service/service-list-one.blade.php ENDPATH**/ ?>