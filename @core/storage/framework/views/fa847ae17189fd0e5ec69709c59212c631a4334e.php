                                                        ...
                                                        <div class="top-part">
                                                            ...
                                                            <span class="title">
                                                                 <?php if($msg->type == 'buyer'): ?>
                                                                    <?php echo e(substr(optional($report_details->buyer)->name ?? 'B',0,1)); ?>
...
<?php endif; ?>
                                            ...
                                            <form action="<?php echo e(route('admin.order.report.chat.buyer',$report_details->id.'/'.$report_details->buyer_id)); ?>" method="post" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/backend/pages/orders/report-chat-buyer.blade.php ENDPATH**/ ?>