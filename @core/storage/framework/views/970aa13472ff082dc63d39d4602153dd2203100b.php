...
<div class="site-watermark">
    <img src="<?php echo e($logo_url); ?>" alt="Watermark">
</div>

<!-- رسالة الحماية -->
<div class="copy-protection-message" id="copyProtectionMessage">
    <?php echo e(__('النسخ محظور')); ?>
...
(function() {
    ...
    // الحصول على لوجو الموقع
    var logoUrl = <?php echo json_encode($logo_url, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/frontend/partials/watermark-protection.blade.php ENDPATH**/ ?>