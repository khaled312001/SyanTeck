        ...
        <div class="container">
            ...
            <div class="mb-2">
              ...
              <div id="services_sub_category_load_wrap">
                    ...
                    <div class="col-lg-3 col-sm-6 margin-top-30 category-child">
                        <div class="single-category style-02 wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="category-contents">
                                ...
                                <span class="category-para">  <?php echo e(sprintf(__('Service').'%s',$sub_cat->total_service)); ?> </span>
                            </div>
                        </div>
                    </div>
               ...
               <?php if(!empty(get_static_option('load_more_button_show_hide_settings'))): ?>
                            ...
                            <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="services-contents">
                                    ...
                                    <div class="btn-wrapper d-flex flex-wrap">
                                        <a href="<?php echo e(url('/qr')); ?>" class="cmn-btn btn-small btn-bg-1"> <?php echo e(__('Book Now')); ?> </a>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SyanTeck\@core\resources\views/frontend/pages/services/category-services.blade.php ENDPATH**/ ?>