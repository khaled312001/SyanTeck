...
class GeneralSettingsController extends Controller
{
    ...
    {
        return view('backend.general-settings.otp');
    }

    public function update_otp_settings(Request $request)
    {
        $this->validate($request, [
            'TWILIO_SID' => 'required',
            'TWILIO_AUTH_TOKEN' => 'required',
            'TWILIO_NUMBER' => 'required',
            'user_otp_expire_time' => 'nullable'
        ]);

        $all_fields = [
            'user_otp_expire_time',
        ];
        ...
        $env_val['TWILIO_SID'] = $request->TWILIO_SID;
        $env_val['TWILIO_AUTH_TOKEN'] = $request->TWILIO_AUTH_TOKEN;
        $env_val['TWILIO_NUMBER'] = $request->TWILIO_NUMBER;
        setEnvValue($env_val);
    ...
    public function update_basic_settings(Request $request)
    {
        $this->validate($request, [
            ...
            'disable_user_otp_verify' => 'nullable|string',
            'user_otp_expire_time' => 'nullable|string',
   ...
   public function update_smtp_settings(Request $request){
    ...
    public function update_payment_settings(Request $request)
    {
        ...
        $field_rules = [
            ...
            // kineticpay
            'kineticpay_username' => 'nullable|string|max:191',
            'kineticpay_preview_logo' => 'nullable|string|max:191',
            'kineticpay_gateway' => 'nullable|string|max:191',
            'kineticpay_test_mode' => 'nullable|string|max:191',
