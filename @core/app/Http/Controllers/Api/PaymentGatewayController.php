        ...
        foreach($gateway_list as $glist ){
            switch($glist){
                ...
                case("zitopay"):
                    ...
                    break;
                    case("kineticpay"):
                    if(!empty(get_static_option('kineticpay_gateway'))){

                        $kineticpay_mode = get_static_option('kineticpay_test_mode');
                        $kineticpay_img_url = null;
                        $kineticpay_img_details = get_attachment_image_by_id(get_static_option('kineticpay_preview_logo'), 'full');
                        $kineticpay_img_url =  $kineticpay_img_details['img_url'] ?? null;

                        $list[] = [
                            "name" => "kineticpay",
                            "test_mode" => (bool) !empty($kineticpay_mode),
                            "logo_link" => $kineticpay_img_url,
                            "username" => get_static_option('kineticpay_username'),
                        ];
                    }
                    break;
                default: 
