...
class ServiceController extends Controller
{
    ...
    {
        $categories  = Category::select('id', 'name', 'status')->whereHas('services')->where('status', 1)->paginate(20);
        if($categories){
            return response()->success([
    ...
    public function serviceSubCategory()
    {
        ...
        $sub_category  = Subcategory::whereIn('category_id', $category_ids)->where('status', 1)->paginate(20);
    ...
    public function serviceChildCategory()
    {
        ...
        $child_category  = ChildCategory::whereIn('sub_category_id', $sub_category_ids)->where('status', 1)->paginate(20);
        if($child_category){
            return response()->success([
