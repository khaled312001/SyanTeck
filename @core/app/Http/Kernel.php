...
//        'demo' => \App\Http\Middleware\Demo::class,
        'banned' => \App\Http\Middleware\UserBanned::class,
        'user_post' => \App\Http\Middleware\UserPostPermission::class,
        ...
        // Middleware للأدوار الجديدة للصيانة
        'technician' => \App\Http\Middleware\TechnicianCheck::class,
        'support' => \App\Http\Middleware\SupportCheck::class,
        'quality' => \App\Http\Middleware\QualityCheck::class,
        'finance' => \App\Http\Middleware\FinanceCheck::class,
        'client' => \App\Http\Middleware\ClientCheck::class,
    ];
