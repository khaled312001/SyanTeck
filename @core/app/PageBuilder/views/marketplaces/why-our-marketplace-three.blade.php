<!-- Choose area starts -->
<section class="new_choose_area why-choose-section section-padding section-wrapper" data-padding-top="{{$padding_top}}" data-padding-bottom="{{$padding_bottom}}" style="background-color:{{$section_bg}}">
    ...
    <div class="container">
        <div class="section-title-wrapper">
            ...
            <p class="section-subtitle section-para">{{ $subtitle }}</p>
        </div>
        
        <!-- CTA Button Below Text -->
        <div class="text-center mt-4 mb-5">
            @if(!empty($customer_btn_text))
            <a href="{{ $customer_btn_link }}" class="why-choose-cta-btn">
                <i class="fa-solid fa-user-plus"></i>
                <span>{{ $customer_btn_text }}</span>
            </a>
            @endif
        </div>
        ...
        <div class="row g-4 why-choose-cards-wrapper">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="why-choose-card-modern" style="animation-delay: {{ $key * 0.15 }}s;">
                    <div class="why-choose-card-inner">
                        ...
                        <div class="why-choose-card-content">
                            <h5 class="why-choose-card-title">{{ $title }}</h5>
                            <p class="why-choose-card-description">{{ $repeater_data['description_'][$key] }}</p>
                        </div>
                    </div>
                </div>
            </div>
