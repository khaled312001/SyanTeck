...
<section class="join-team-section section-padding section-wrapper" data-padding-top="{{$padding_top}}" data-padding-bottom="{{$padding_bottom}}" style="background-color:{{$section_bg}}">
    ...
    <div class="container">
        ...
        <div class="section-title-wrapper text-center mb-5">
            <h2 class="section-title" style="color:{{$title_text_color}}">انضم إلى فريق عمل صيانة تك</h2>
        ...
        <div class="row g-4 job-categories-grid">
            ...
            @foreach($job_categories as $index => $job)
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="job-card-modern" style="animation-delay: {{ $index * 0.1 }}s;">
                    <div class="job-card-inner">
                        <div class="job-card-icon" style="background: linear-gradient(135deg, {{ $job['color'] }} 0%, #FFA500 100%);">
                            <i class="{{ $job['icon'] }}"></i>
                        </div>
                        <div class="job-card-content">
                            <h5 class="job-card-title">{{ $job['title'] }}</h5>
                            <p class="job-card-description">{{ $job['description'] }}</p>
                            <a href="{{ $job['link'] }}" class="job-card-btn">
                                <span>انضم الآن</span>
        ...
        <!-- Benefits Section -->
        @if(!empty($content_list_show_hide) && isset($repeater_data['benifits_']))
        ...
        <div class="text-center mt-5">
            <a href="{{ $btn_link }}" class="join-team-cta-btn" style="background:{{$btn_color}}">
                <i class="fa-solid fa-user-plus"></i>
                <span>{{ $btn_text ?: 'انضم إلى فريقنا الآن' }}</span>
            </a>
        </div>
    </div>
</section>
