            ...
            <div class="single-service service-two style-03 service-padding section-bg-2 wow fadeInUp" data-wow-delay=".2s">
                ...
                <div class="services-contents content-padding-reverse">
                    ...
                    <div class="btn-wrapper">
                        <a href="{$book_now}" class="cmn-btn btn-bg-3" style="background:{$btn_color}; color:{$btn_text_color}"> {$book_appoinment} </a>
                    </div>
                </div>
            </div>
        </div>
...
HTML;
    ...
    {
        return __('Featured Service: 02') . ' <span class="text-danger">(' . __('Deprecated') . ')</span>';
    }
}