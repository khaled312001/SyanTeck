                ...
                <div class="single-service {$dot_color_slider}">
                    ...
                    <div class="services-contents">
                        ...
                        <div class="btn-wrapper">
                            <a href="{$book_now}" class="cmn-btn btn-appoinment btn-bg-1" style="background:{$btn_color}; color:{$btn_text_color}"> {$book_appoinment} </a>
                        </div>
                    </div>
                </div>
            </div>
...
HTML;
    ...
    {
        return __('Featured Service') . ' <span class="text-danger">(' . __('Deprecated') . ')</span>';
    }
}