...
class StaticOptionsTableSeeder extends Seeder
{
    public function run()
    {
        $fields = [
            ...
            'seller_report_subject'=>__('Technician New Report'),
            'seller_report_message'=>'<p>Hello,</p><p>New report is just created by a technician. Please check , thanks</p><p>Report id: @report_id</p>',
            'seller_payout_subject'=>__('Technician Payout Request'),
            'seller_payout_message'=>'<p>Hello,</p><p>
                                         </p><div>
                                        </div><div>New payout request is just created by a technician. Please check , thanks</div><div><br></div><div>
            ...
            'seller_verification_subject'=>__('Technician Verification Request'),
            'seller_verification_message'=>'<p>Hello,</p><p>
                                             </p><div>
                                            </div><div>You have a new request for technician verification.</div><div>
                                            </div><p></p>',
            ...
            'seller_to_buyer_extra_service_message'=>'<p>Hello @buyer_name</p><p><br></p><p>
                                                    ...
                                                    </div><div>Technician added extra service in your order.</div><div><br></div><div>Order id: @order_id</div><div>
                                                    </div><p></p>',
            'buyer_order_decline_subject'=>__('Order Complete Request Decline'),
            'buyer_order_decline_message'=>'<p>Your request to complete an order has been decline by the client</p><p>Order id: @order_id</p>',
            'buyer_to_admin_extra_service_message'=>'<p>A client has been decline a request to complete an order.</p><div><br></div><div>Order id: @order_id</div><div>
                                                     </div><p></p>',
            'buyer_report_subject'=>__('Client New Report'),
            'buyer_report_message'=>'<p>Hello,</p><p>New report is just created by a client. Please check , thanks</p><p>Report id: @report_id</p>',
            ...
            'buyer_extra_service_message'=>'<p>Hello @buyer_name</p><p>You have accepted extra service&nbsp; added by technician in your order.</p><p>Order id: @order_id</p>',
            'buyer_to_seller_extra_service_message'=>'<p>Hello @seller_name</p><p><br></p><p>
                                             </p><div>
                                            </div><div>Client accepted the&nbsp; extra service added buy you&nbsp; in your order.</div><div><br></div><div>Order id: @order_id</div><div>
                                            </div><p></p>',
            ...
            'admin_seller_verification_subject'=>__('Technician Verification Success'),
            'admin_seller_verification_message'=>'<p></p><p>Hello @name,</p><p>Your verification is success. Now you are a verified technician.</p><p>
                                                    </p><p></p> <p></p>',
            ...
            'buy_subscription_admin_message'=>'<p>A technician just buy a subscription</p><p>Subscription infos---
                                                </p><p>Subscription type: @type
                                                </p><p>Subscription price: @price
                                                </p><p>Subscription connect: @connect</p><p>Technician name: @seller_name</p><p>Technician email: @seller_email</p>',
            ...
            'renew_subscription_admin_message'=>'<p>A technician just renew his subscription</p><p>
                                                     <div>
                                                    </div><div>Subscription infos---
                                                    </div><div>Subscription type: @type
                                                    </div><div>Subscription price: @price
                                                    </div><div>Subscription connect: @connect
                                                    </div><div>Technician name: @seller_name
                                                    </div><div>Technician email: @seller_email</div><div>
                                                    </div><div>
                                                    </div><div>
                                                    </div><div>
                                                    </div><div>
