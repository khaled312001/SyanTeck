...
<div class="page-container">
    ...
    @include('quality.partials.sidebar')
                ...
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="breadcrumbs pull-left">
                            <li><a href="{{route('quality.dashboard')}}">{{__('Home')}}</a></li>
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('quality.dashboard')}}">
                                <i class="ti-dashboard mr-2"></i> {{__('Dashboard')}}
                            </a>
                            <a class="dropdown-item" href="{{route('quality.profile')}}">
                                <i class="ti-user mr-2"></i> {{__('Profile')}}
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('quality.logout') }}">
