...
@section('content')
    <!-- Child Category Service area starts -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @if($all_services->count() >= 1)
                    ...
                    @endif
                @else
                    <div class="alert alert-warning">{{sprintf(__('No services found in').'%s',optional($child_category)->name)}}</div>
                @endif
    ...
    <!-- child Category Service area end -->
