                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <div class="right-content">
                                <a href="{{ route('admin.update.single.service.data', $service->id) }}" class="btn btn-warning btn-sm" onclick="return confirm('هل تريد تحديث هذه الخدمة بالبيانات الوهمية الكاملة؟')">
                                    <i class="ti-reload"></i> {{__('Fill Missing Data')}}
                                </a>
                            </div>
                        </div>
                        <form action="{{route('admin.edit.service',$service->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="single-dashboard-input">
                                <div class="single-info-input margin-top-30">
                                    <label for="is_service_online" class="info-title"> {{__('Service Type')}} </label>
                                    <select name="is_service_online" id="is_service_online" class="form-control">
                                        <option value="0" @if($service->is_service_online == 0) selected @endif>{{__('Offline Service')}}</option>
                                        <option value="1" @if($service->is_service_online == 1) selected @endif>{{__('Online Service')}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="single-dashboard-input">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="single-info-input margin-top-30">
                                            <label for="price" class="info-title"> {{__('Service Price*')}} </label>
                                            <input class="form-control" name="price" id="price" value="{{ $service->price ?? 0 }}" type="number" step="0.01" min="0" placeholder="{{__('Enter price')}}">
                                            <small class="text-muted">{{__('For offline services')}}</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="single-info-input margin-top-30 service-online-price" style="@if($service->is_service_online != 1) display:none; @endif">
                                            <label for="online_service_price" class="info-title"> {{__('Online Service Price*')}} </label>
                                            <input class="form-control" name="online_service_price" id="online_service_price" value="{{ $service->online_service_price ?? 0 }}" type="number" step="0.01" min="0" placeholder="{{__('Enter online price')}}">
                                            <small class="text-muted">{{__('For online services')}}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="single-dashboard-input service-online-fields" style="@if($service->is_service_online != 1) display:none; @endif">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="single-info-input margin-top-30">
                                            <label for="delivery_days" class="info-title"> {{__('Delivery Days*')}} </label>
                                            <input class="form-control" name="delivery_days" id="delivery_days" value="{{ $service->delivery_days ?? 0 }}" type="number" min="0" placeholder="{{__('Enter delivery days')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="single-info-input margin-top-30">
                                            <label for="revision" class="info-title"> {{__('Revision')}} </label>
                                            <input class="form-control" name="revision" id="revision" value="{{ $service->revision ?? 0 }}" type="number" min="0" placeholder="{{__('Enter revision count')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
