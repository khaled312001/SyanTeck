                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @can('admin-service-attributes-add')
                                                <a href="{{ route('admin.add.service.attributes.by.id',$data->id) }}" class="btn btn-xs btn-dark mb-3">{{ __('Add Attributes') }}</a>
                                            @endcan
                                            @can('admin-service-attributes-edit')
                                                <a href="{{ route('admin.edit.service.attributes.by.id',$data->id) }}" class="btn btn-xs btn-danger mb-3">{{ __('Edit Attributes') }}</a>
                                            @endcan
                                            @can('admin-service-attributes-show')
                                                <a href="{{ route('admin.show.service.attributes.by.id',$data->id) }}" class="btn btn-xs btn-info mb-3">{{ __('Show Attributes') }}</a>
                                            @endcan
