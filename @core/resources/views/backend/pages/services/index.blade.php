                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <div class="right-content">
                                <a href="{{ route('admin.update.all.services.data', ['force' => 1]) }}" class="btn btn-primary" onclick="return confirm('هل أنت متأكد من تحديث جميع الخدمات بالبيانات الوهمية الكاملة؟ سيتم تحديث جميع الخدمات حتى التي لديها بيانات موجودة.')">
                                    <i class="ti-reload"></i> {{__('Update All Services Data')}}
                                </a>
                            </div>
                        </div>
