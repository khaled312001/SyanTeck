...
<div class="main-content-inner">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('support.profile.update') }}">
                        @csrf
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p><strong>{{__('Role')}}:</strong> {{ $user->roles->first()->name ?? __('Support Agent') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">{{__('Activity Log')}} - {{__('Recent Orders')}}</h4>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('support.orders.show', $activity->id) }}" class="btn btn-sm btn-primary">
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center">{{__('No activities found')}}</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
