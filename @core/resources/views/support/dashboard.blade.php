...
<div class="main-content-inner">
    <div class="row">
        <!-- Statistics Cards -->
        <div class="col-xl-2 col-lg-4 col-md-6 mt-5">
            <div class="card">
                <div class="card-body">
        ...
        <div class="col-xl-2 col-lg-4 col-md-6 mt-5">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <p class="mb-0">{{__('Cancelled Orders')}}</p>
                            <h3 class="mt-2 text-danger">{{ $stats['cancelled'] }}</h3>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="data-tables datatable-primary">
                        ...
                        <div class="mt-3 text-center">
                            <a href="{{ route('support.orders') }}" class="btn btn-primary">{{__('View All Orders')}}</a>
                        </div>
                        @endif
                    </div>
                </div>
