                ...
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="breadcrumbs pull-left">
                            <li><a href="{{route('support.dashboard')}}">{{__('Home')}}</a></li>
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right dropdown">
                        ...
                        <div class="user-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="user-role">{{ Auth::user()->roles->first()->name ?? __('Support Agent') }}</span>
                        </div>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{route('support.dashboard')}}">
                                <i class="ti-dashboard mr-2"></i> {{__('Dashboard')}}
                            </a>
                            <a class="dropdown-item" href="{{route('support.profile')}}">
                                <i class="ti-user mr-2"></i> {{__('Profile')}}
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('support.logout') }}">
