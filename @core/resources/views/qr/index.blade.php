...
@section('page-title')
{{__('Request Maintenance Service')}}
@endsection

@section('site-title')
{{__('Request Maintenance Service')}} - {{get_static_option('site_title')}}
@endsection

@section('page-meta-data')
{!! render_site_title(__('Request Maintenance Service')) !!}
<meta name="description" content="{{__('Request maintenance service quickly and easily through our platform')}}">
@endsection
            ...
            <div class="col-lg-10 col-xl-9">
                <div class="qr-request-wrapper enhanced-qr-wrapper">
                    ...
                    <div class="request-header text-center margin-bottom-50">
                        ...
                        <h1 class="request-title">{{__('Request Maintenance Service')}}</h1>
                        <p class="request-subtitle">{{__('Fill out the form below to request a maintenance service. Our team will contact you shortly.')}}</p>
                            ...
                            <div class="form-section margin-bottom-40">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 margin-bottom-20">
                                        ...
                                        <small class="form-text text-muted">{{__('The technician will determine the price after inspection')}}</small>
                                    </div>
                                </div>
                            ...
                            <div class="form-section margin-bottom-40">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 margin-bottom-20">
                                        ...
                                        <textarea name="address" class="form-control" rows="3" required placeholder="{{__('Enter your full address')}}"></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 margin-bottom-20">
                                        <label class="form-label">
                                            ...
                                            {{__('Issue Image')}} <small class="text-muted">({{__('Optional')}})</small>
                                        </label>
                                        <div class="image-upload-wrapper">
                                            <input type="file" name="issue_image" id="issue_image" class="form-control-file" accept="*/*" onchange="previewFile(this)">
                                            <small class="form-text text-muted">{{__('Upload a photo, video, or file of the issue or problem (Max: 500MB, Any format)')}}</small>
                                            <div id="file-preview" class="file-preview-container" style="display: none; margin-top: 15px;">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger mt-2" onclick="removeFile()">
                                                    <i class="las la-times"></i> {{__('Remove File')}}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
